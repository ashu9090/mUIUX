...
const Footer = () => (
  <section className={`${styles.flexCenter} ${styles.paddingX} flex-col`}>
    <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
      <div className="flex-1 flex flex-col justify-start mr-10">
        ...
        <p className={`${styles.paragraph}`}>
          Consectetur amet nisi in quis anim minim dolore occaecat consectetur
          deserunt incididunt.
        </p>
      </div>
    ...
    <div
      className="w-full flex justify-between items-center md:flex-row flex-col py-6 border-t-[1px]
     border-t-[#3f3e45]"
    >
      <p className="font-poppins font-normal text-center text-[14px] leading-[27px] text-white">
        @copy right 2022 Name. All right Reserved.
      </p>
